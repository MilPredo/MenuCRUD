...
function App() {
  ...
  useEffect(()=>{
    ...
    setProductData(productDataFirebaseConvertKVToArrays(productList))
    console.log("lol?",productData)
  },[productList])
 
  // useEffect(() => {
  //   let newProductData = productDataFirebase.forEach((data) => {
  //     let newData: ProductData = {...data, optionSets:[]} 
